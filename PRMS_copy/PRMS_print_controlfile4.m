...
con_filname = '/home/gcng/workspace/ModelRuns_scratch/PRMS_projects/Salta/control/Salta_test.control';

% command-line executable
PRMS_exe = '/home/gcng/workspace/Models/PRMS/prms4.0.1_linux/bin/prms'; 

% java program for GUI (optional, only for printing execution info)
PRMS_java_GUI = '/home/gcng/workspace/Models/PRMS/prms4.0.1_linux/dist/oui4.jar'; 

% data file that the control file will point to
datafil = '/home/gcng/workspace/ModelRuns_scratch/PRMS_projects/Salta/inputs/empty.dat';

% Climate-hru data files
...
% parameter file that the control file will point to
parfil = '/home/gcng/workspace/ModelRuns_scratch/PRMS_projects/Salta/inputs/Salta_test.param';

% output directory that the control file will point to for creating output files (include slash at end!)
outdir = '/home/gcng/workspace/ModelRuns_scratch/PRMS_projects/Salta/output/';
% *************************************************************************
...
con_par_type(ii) = 1; 
con_par_values{ii} = [1971, 1, 1, 0, 0, 0];

ii = ii+1;
con_par_name{ii} = 'end_time';
con_par_type(ii) = 1; 
con_par_values{ii} = [1971, 1, 26, 0, 0, 0]; % year, month, day, hour, minute, second
...
con_par_type(ii) = 4; 
con_par_values{ii} = {'strmflow'}; % strmflow, muskingum, strmflow_in_out, or strmflow_lake
...
con_par_type(ii) = 4; 
con_par_values{ii} = {[outdir, 'SaltaOut.statvar']};
