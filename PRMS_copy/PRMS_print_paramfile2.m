...
% *** DO A CHECK FOR "CHANGE FOR SALTA" ***
% *************************************************************************
...
par_value{ii} = ones(dim_value(strcmp(dim_name, par_dim_name{ii})),1);  % [acre]
...
par_dim_name{ii} = {'nhru'};
par_type(ii) = 2; % 1=int, 2=single prec, 3=double prec, 4=char str
par_value{ii} = ones(dim_value(strcmp(dim_name, par_dim_name{ii})),1);  % [angular degrees]
...
par_dim_name{ii} = {'nhru'};
par_type(ii) = 2; % 1=int, 2=single prec, 3=double prec, 4=char str
par_value{ii} = 100 * ones(dim_value(strcmp(dim_name, par_dim_name{ii})),1);  % elev_units = m
...
par_dim_name{ii} = {'nhru'};
par_type(ii) = 2; % 1=int, 2=single prec, 3=double prec, 4=char str
par_value{ii} = -45*ones(dim_value(strcmp(dim_name, par_dim_name{ii})),1);  % angular degrees
...
par_type(ii) = 2; % 1=int, 2=single prec, 3=double prec, 4=char str
par_value{ii} = 1.7*ones(par_num(ii),1);  % [-], default: 1.26
...
par_dim_name{ii} = {'nhru'};
par_type(ii) = 1; % 1=int, 2=single prec, 3=double prec, 4=char str
par_value{ii} = ones(dim_value(strcmp(dim_name, par_dim_name{ii})),1);  % mercd: all 1's
