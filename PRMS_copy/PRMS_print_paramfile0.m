...
parfil = '/home/gcng/workspace/ModelRuns_scratch/PRMS_projects/ESCI5980/merced/input/mercdIDE_test.param';
% *************************************************************************
...
% ****to be read in from GIS info****
ii = ii+1;
par_name{ii} = 'tosegment'; % stream segment that hru ultimately flows to (ignored if fl_cascade=1?)
