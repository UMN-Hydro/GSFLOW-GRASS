...
in_GISdata_dir = strcat(in_data_dir, 'GISinput/'); % specifically GIS data

% parameter file that will be written (name must match that in Control file!)
parfil = [PRMSinput_dir, 'PRMS.param'];

% GIS-generated files read in to provide values to PRMS input file
HRUfil = strcat(in_data_dir, 'HRU.csv');
segmentfil = strcat(in_GISdata_dir, 'segment.csv');
% *************************************************************************
