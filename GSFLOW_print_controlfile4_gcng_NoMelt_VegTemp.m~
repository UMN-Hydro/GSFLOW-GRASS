...
% - control file name _NoMelt_VegTemp
% - precip WITHOUT melt (precip*.day)
% - Veg shift (ChimTestVegShift_GSFLOW.param)
% - plus 1C (tmin*.day, tmax*.day)
...
con_filname0 = 'ChimTest_NoMelt_VegTemp_Run5yrs';
...
parfil_pre = 'ChimTestVegShift'; % will have '_', model_mode following
