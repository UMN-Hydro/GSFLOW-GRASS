...
import numpy as np
from MODFLOW_scripts import MODFLOW_NWT_lib_Shullcas as mf # functions to write individual MODFLOW files
...
GIS_indir = settings.LOCAL_DIR + slashstr + 'data' + slashstr + 'GIS' + slashstr
