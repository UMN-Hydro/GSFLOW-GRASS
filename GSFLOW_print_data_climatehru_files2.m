...
precip_datafil = strcat(PRMSinput_dir, inname, '/precip_rep30yr.day');
tmax_datafil = strcat(PRMSinput_dir, inname, '/tmax_rep30yr.day');
tmin_datafil = strcat(PRMSinput_dir, inname, '/tmin_rep30yr.day');
