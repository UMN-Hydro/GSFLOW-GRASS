...
parfil = strcat(PRMSinput_dir, inname, '/ChimTest_PRMS.param');
...
%Write gsflow.csv file
Date_Day = ymdhms_v (1:,);
T = table (Date_Day, 'basinppt', 'basinpervet', 'basinimpervevap', ...
    'basinintcpevap', 'basinsnowevap', 'basinstrmflow', 'basinsz2gw', ...
    'basingw2sz', 'gw_inout', 'stream_leakage', 'uzf_recharge', 'basinseepout', ...
    'sat_stor', 'unsat_stor', 'basinsoilmoist', 'basingravstor', 'basingwstor', ...
    'basinintcpstor', 'basinimpervstor', 'basinpweqv', 'basininterflow', 'basinsroff', ...
    'strm_stor', 'lake_stor', 'obs_strmflow', 'basinszreject', 'basinprefstor', 'uzf_et', ...
    'uzf_infil', 'uzf_del_stor', 'uzf_del_stor', 'net_sz2gw', 'sat_change_stor', 'streambed_loss', ...
    'sfruz_change_stor', 'gwflow2strms', 'sfruz_tot_stor', 'lakebed_loss', 'lake_change_stor', ...
    'gwflow2lakes', 'basininfil', 'basindunnian', 'basinhortonian', 'basinsm2gvr', 'basingvr2sm', ...
    'basininfil_tot', 'basininfil2pref', 'basindnflow', 'basinactet', 'basinsnowmelt', ...
    'basinhortonianlakes', 'basinlakeinsz', 'basinlakeevap','basinlakeprecip', 'basinfarfieldflow', ...
    'basinsoiltogw', 'basinszfarflow', 'basinsrofffarflow', 'basinswaleet', 'unsat_et', ...
    'sat_et', 'basinnetgwwel', 'kkiter', 'gsflow.csv');
